...
const allTypes = [
  { types: ['feat', 'feature'], header: 'New Features', icon: '🚀' },
  {
    types: ['fix', 'bugfix'],
    header: 'Bug Fixes',
    icon: '🐛',
  ...
  { types: ['perf'], header: 'Performance Improvements', icon: '⚡' },
  { types: ['refactor'], header: 'Refactors', icon: '♻️' },
  { types: ['test', 'tests'], header: 'Tests', icon: '✅' },
  {
    types: ['build', 'ci'],
    header: 'Build System',
    icon: '👷'
  },
  { types: ['doc', 'docs'], header: 'Documentation Changes', icon: '📄' },
  { types: ['style'], header: 'Code Style Changes', icon: '🎨' },
  { types: ['chore'], header: 'Chores', icon: '🔧' },
  { types: ['other'], header: 'Other Changes', icon: '❔' }
]
